// Package openapi2 parses Swagger 2.0 documents into API Elements.
package openapi2
...
// A note on the duplication: this file is the same YAML reader the OpenAPI 3
// parser uses. Sharing it means a package both parsers depend on, and the two
// formats are close enough that a shared reader would keep growing conditionals
// for whichever one is asking. Two copies of a settled 200-line reader is the
// cheaper of the two problems; if a third format arrives, extract it then.
